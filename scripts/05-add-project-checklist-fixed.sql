...
DROP POLICY IF EXISTS "Anyone can view public templates" ON public.project_checklist_templates;
DROP POLICY IF EXISTS "Users can create templates" ON public.project_checklist_templates;
DROP POLICY IF EXISTS "Users can update own templates" ON public.project_checklist_templates;
DROP POLICY IF EXISTS "Project members can view checklist items" ON public.project_checklist_items;
DROP POLICY IF EXISTS "Project managers can manage checklist items" ON public.project_checklist_items;
...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_project_checklist_items_project_id ON public.project_checklist_items(project_id);
CREATE INDEX IF NOT EXISTS idx_project_checklist_items_completed ON public.project_checklist_items(is_completed);
...
DROP TRIGGER IF EXISTS on_checklist_item_change ON public.project_checklist_items;
